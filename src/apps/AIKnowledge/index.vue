...
const resources: Resource[] = [
  ...
  { name: 'Chatbox', desc: 'AI客户端对话工具', url: 'https://chatboxai.com/', icon: '💬', tags: ['工具'] },
  { name: 'OpenCode', desc: '开源AI编程助手', url: 'https://github.com/sst/opencode', icon: '⚡', tags: ['工具'] },
  { name: 'OpenAI Docs', desc: '官方API文档', url: 'https://platform.openai.com/docs', icon: '📚', tags: ['学习'] },
